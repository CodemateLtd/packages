...
public class Messages {
  ...
  public static final class PlatformBitmapRegisteredMapBitmap {
    ...
    static @NonNull PlatformBitmapRegisteredMapBitmap fromList(@NonNull ArrayList<Object> pigeonVar_list) {
  ...
  public interface ImageRegistryApi {
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @Nullable ImageRegistryApi api) {
      setUp(binaryMessenger, "", api);
    }
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable ImageRegistryApi api) {
      messageChannelSuffix = messageChannelSuffix.isEmpty() ? "" : "." + messageChannelSuffix;
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.addBitmapToCache" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                PlatformBitmap bitmapArg = (PlatformBitmap) args.get(1);
                try {
                  api.addBitmapToCache(idArg, bitmapArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.removeBitmapFromCache" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ...
                Long idArg = (Long) args.get(0);
                try {
                  api.removeBitmapFromCache(idArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  wrapped = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.clearBitmapCache" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
