...
class ImageRegistryApi {
  ...
  Future<void> addBitmapToCache(int id, PlatformBitmap bitmap) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.addBitmapToCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    final List<Object?>? pigeonVar_replyList =
        await pigeonVar_channel.send(<Object?>[id, bitmap]) as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
      throw PlatformException(
  ...
  Future<void> removeBitmapFromCache(int id) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.removeBitmapFromCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> clearBitmapCache() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.clearBitmapCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
