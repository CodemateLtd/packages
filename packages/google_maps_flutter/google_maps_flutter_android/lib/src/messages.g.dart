...
class ImageRegistryApi {
  ...
  Future<void> addBitmapToCache(int id, PlatformBitmap bitmap) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.addBitmapToCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<void> clearBitmapCache() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_maps_flutter_android.ImageRegistryApi.clearBitmapCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
