...
extern void SetUpFGMImageRegistryApi(id<FlutterBinaryMessenger> binaryMessenger,
                                     NSObject<FGMImageRegistryApi> *_Nullable api);

extern void SetUpFGMImageRegistryApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger,
                                               NSObject<FGMImageRegistryApi> *_Nullable api,
                                               NSString *messageChannelSuffix);
