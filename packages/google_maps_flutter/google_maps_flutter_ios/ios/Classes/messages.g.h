...
@protocol FGMImageRegistryApi
/// Adds a bitmap to the cache.
- (void)addBitmapToCacheId:(NSInteger)id bitmap:(FGMPlatformBitmap *)bitmap error:(FlutterError *_Nullable *_Nonnull)error;
...
extern void SetUpFGMImageRegistryApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FGMImageRegistryApi> *_Nullable api);

extern void SetUpFGMImageRegistryApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FGMImageRegistryApi> *_Nullable api, NSString *messageChannelSuffix);
