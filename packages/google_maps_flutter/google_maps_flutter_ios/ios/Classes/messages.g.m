...
+ (FGMPlatformGroundOverlay *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.anchor = GetNullableObjectAtIndex(list, 6);
  pigeonResult.transparency = [GetNullableObjectAtIndex(list, 7) doubleValue];
  pigeonResult.bearing = [GetNullableObjectAtIndex(list, 8) doubleValue];
