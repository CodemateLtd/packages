...
- (void)testUpdateMarkerSetsVisibilityLast {
  PropertyOrderValidatingAdvancedMarker *marker = [[PropertyOrderValidatingAdvancedMarker alloc] init];
...
- (void)testUpdateAdvancedMarkerSetsVisibilityLast {
  PropertyOrderValidatingAdvancedMarker *marker = [[PropertyOrderValidatingAdvancedMarker alloc] init];
  [FLTGoogleMapMarkerController
                   updateMarker:marker
             fromPlatformMarker:[FGMPlatformMarker
...
- (void)setCollisionBehavior:(id)collisionBehavior {
  XCTAssertFalse(self.hasSetMap, @"Property set after map was set.");
