...
class MapsInspectorApi {
  ...
  Future<bool> hasRegisteredMapBitmap(int id) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_maps_flutter_ios.MapsInspectorApi.hasRegisteredMapBitmap$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
...
class ImageRegistryApi {
  ...
  Future<void> addBitmapToCache(int id, PlatformBitmap bitmap) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_maps_flutter_ios.ImageRegistryApi.addBitmapToCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<void> removeBitmapFromCache(int id) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_maps_flutter_ios.ImageRegistryApi.removeBitmapFromCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<void> clearBitmapCache() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.google_maps_flutter_ios.ImageRegistryApi.clearBitmapCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
