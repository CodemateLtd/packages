...
class ImageRegistryApi {
  ...
  Future<void> addBitmapToCache(int id, PlatformBitmap bitmap) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_ios.ImageRegistryApi.addBitmapToCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> removeBitmapFromCache(int id) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_ios.ImageRegistryApi.removeBitmapFromCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> clearBitmapCache() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_ios.ImageRegistryApi.clearBitmapCache$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
